...
void conv_2d_large_cl_nopad_pad(
	...
	/*
    //convert the input single stream with array to an array of stream
    hls::stream< typename data_T::value_type> in_data[CONFIG_T::n_chan];
   #pragma HLS STREAM variable=in_data 
    data_T tmp_in;
    res_T out_data;
